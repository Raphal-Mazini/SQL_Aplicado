...
CREATE TABLE mc_cidade (
    cd_cidade  NUMERIC GENERATED ALWAYS AS IDENTITY NOT NULL,
    sg_estado  CHAR(2) NOT NULL,
...
CREATE TABLE mc_logradouro (
    cd_logradouro  NUMBER(8) GENERATED ALWAYS AS IDENTITY NOT NULL,
...
CREATE TABLE mc_funcionario (
    cd_funcionario     NUMBER(8) GENERATED ALWAYS AS IDENTITY NOT NULL,
...
CREATE TABLE mc_depto (
    cd_depto  NUMBER(8) GENERATED ALWAYS AS IDENTITY NOT NULL,
...
CREATE TABLE mc_produto (
    cd_produto         NUMBER(8) GENERATED ALWAYS AS IDENTITY NOT NULL,
...
CREATE TABLE mc_sgv_visualizacao_video (
    cd_visualizacao_video  NUMBER(8) GENERATED ALWAYS AS IDENTITY NOT NULL,
    nr_cliente             NUMBER(10) NOT NULL,
    cd_produto             NUMBER(10) NOT NULL,
    nr_sequencia           NUMBER(3) NOT NULL,
...
CREATE TABLE mc_categoria_prod (
    cd_categoria  NUMBER(8) GENERATED ALWAYS AS IDENTITY NOT NULL,
